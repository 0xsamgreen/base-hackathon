...
var WalletService = /** @class */ (function () {
    ...
    WalletService.prototype.createWallet = function () {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, account, client, address;
    ...
    WalletService.prototype.getWalletClient = function (privateKey) {
        return __awaiter(this, void 0, void 0, function () {
            var account;
            return __generator(this, function (_a) {
                account = (0, accounts_1.privateKeyToAccount)("0x".concat(privateKey));
                // Create and return wallet client
                return [2 /*return*/, (0, viem_1.createWalletClient)({
                        account: account,
                        chain: chains_1.baseSepolia,
                        transport: (0, viem_1.http)()
                    })];
    ...
    WalletService.prototype.sendTransaction = function (privateKey, to, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var account, client, hash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        account = (0, accounts_1.privateKeyToAccount)("0x".concat(privateKey));
